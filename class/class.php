...
class db extends Controller {
    ...
    public function get_product_category() {
        $query = $this->db->query("SELECT * FROM products_category_tbl");
        return $query;
    }
    ...
    public function place_order() {
        if(empty($_SESSION['item_cart'])) {
            ...
            foreach($_SESSION['item_cart'] as $key => $value) {
                ...
                $query = '';
                $query .= $this->db->query("INSERT INTO products_transactions_tbl (product_id,product_quantity) VALUES ($product_id,$product_quantity)");
