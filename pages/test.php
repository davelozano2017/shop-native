					...
					<div id="shop" class="shop grid-container clearfix" data-layout="fitRows">
						...
						<div class="product clearfix">
							<div class="product-image">
								...
								<a href="products.php?id=<?=$row_products['product_id']?>"><img style="width:280px;height:250px" src="../assets/uploads/<?=$row_products['product_brand']?>/<?=$row_image['product_images']?>" alt="<?=$row_products['product_name']?>"></a>
								<?php endforeach;?>
							...
							<div class="product-desc">
								<div class="product-title"><h3><a href="products.php?id=<?=$row_products['product_id']?>"><?= $row_products['product_name']?></a></h3></div>
